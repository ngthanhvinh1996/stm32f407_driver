...
typedef struct
{
	...
	uint32_t		TxRxState;		/* !< To store Communication state > */
...
* @I2C other define
*/
#define I2C_DISABLE_SR			RESET	/* No Start Repeat */
#define I2C_ENABLE_SR			SET		/* Start Repeat */
 ...
 */
/* SR1 Register -> I2C Status register */
...
#define I2C_FLAG_SR1_TXNE       ( 1 << I2C_SR1_TXE )

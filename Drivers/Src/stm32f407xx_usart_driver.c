 ...
 *
 *@brief			: This function enables or disables peripheral clock for the given USARTx peripheral
 *
 ...
 ****************************************************************/
  ...
  *@fn				: USART_Init
  *
  *@brief			: This function initialization the USARTx peripheral
  *
  *@param[in]		:
  *@param[in]		:
  *@param[in]		:
...
/******************************** Configuration of BRR(Baudrate register)******************************************/
  ...
  *@fn				: USART_DeInit
  *
  *@brief			: This function de-initialization the USARTx peripheral
  *
  *@param[in]		:
  *@param[in]		:
  *@param[in]		:
  ...
  *@fn				: USART_SendData
  *
  *@brief			: This function send data the USART peripheral
  *
  *@param[in]		:
  *@param[in]		:
  *@param[in]		:
  ...
  *
  *@brief			: This function received data the USART peripheral
  *
  *@param[in]		:
  *@param[in]		:
  *@param[in]		:
...
/****************************************************************
 	...
 	if(temp1 && temp2 )
 	{
 		...
 		if(pUSARTHandle->TxBusyState == USART_BUSY_IN_TX)
 		{
 			...
 			if (pUSARTHandle->TxLen == 0 )
 			{
 				...
 				USART_ClearFlag(pUSARTHandle->pUSARTx, USART_FLAG_SR_TXE);
 			}
 		}
 	}
 ...
 //Note : CTS feature is not applicable for UART4 and UART5
 	...
 	if(temp1  && temp2 && temp3)
 	{
 		...
 		USART_ClearFlag(pUSARTHandle->pUSARTx, USART_FLAG_SR_CTS);
 ...
 /*************************Check for IDLE detection flag ********************************************/
 	...
 	temp1 = pUSARTHandle->pUSARTx->SR & ( 1 << USART_FLAG_SR_IDLE );
